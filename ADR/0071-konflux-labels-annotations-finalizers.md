---
title: "71. Replace Appstudio Labels, Annotations, and Finalizers with Konflux equivalents"
status: Accepted
applies_to:
  - "*"
topics:
...
- Existing labels, annotations, and finalizers currently using `appstudio.openshift.io`, `appstudio.redhat.com`, `build.appstudio.openshift.io`, or other `appstudio` occurrences MUST be migrated to `konflux-ci.dev` following a controlled deprecation process.
...
- The naming structure should follow established Kubernetes conventions (see [official k8s doc patterns](https://kubernetes.io/docs/concepts/overview/working-with-objects/common-labels/)):
