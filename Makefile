...
.PHONY: all help build serve install lint lint-mermaid lint-adr-status lint-eleventy-headers install-mermaid-cli clean

# Default target - lint and build
all: lint build
	@echo "✅ Lint and build completed successfully"

help:
	@echo "Available targets:"
	@echo "  all               - Run lint and build (default)"
