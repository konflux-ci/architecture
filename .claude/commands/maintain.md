...
2. Check service frontmatter:
   - For each service .md file, verify it has a `claude:` frontmatter section
   - Report any services missing this section

3. Verify ADR INDEX.md coverage:
   - List all ADR files in /ADR/ (excluding template)
   - Compare to entries in /ADR/INDEX.md
...
- Also provide immediate guidance on how to fix these issues if the user wants to continue in this session. Be clear in this guidance so that the work can be immediately carried out by another agent.
